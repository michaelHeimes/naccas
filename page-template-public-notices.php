<?php
/*
 Template Name: Public Notices Page
 *
				...
				<main id="main" class="cf bottom-wrapper index-wrap" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
					...
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
						...
						<div class="alm-wrap">
							...
							<?php echo do_shortcode('[ajax_load_more post_type="news" taxonomy="news_categories" taxonomy_terms="public-notices" taxonomy_operator="IN" container_type="div" button_label="View More"]');
